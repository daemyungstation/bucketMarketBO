        ...
        common : {
            ...
            popup : {
                ...
                planner : {
                    ...
                    /**
                     * <pre>
                     * 1. FuntionName : common.popup.planner.search
                     * 2. ClassName  : common.js
                     * 3. Comment    : 레디플래너 검색 공통 팝업
                     * 4. 작성자       : eric
                     * 5. 작성일       : 2022. 6. 9.
                     * </pre>
                     *
                     ...
                     * @param PRD_MST_NO
                     */
                    search : function (CALLBACK, PRP_LIST) {
                        $.common.popup.callback.planner.search = CALLBACK;
                        var params = [];
                        if (typeof(PRP_LIST) != "undefined") {
                            params.push(TagUtil.createDynamicInput("hidden", "PRP_LIST", PRP_LIST));
                        }
                        TagUtil.createDynamicForm("dynamicNaviForm", "")
                            .append(params)
                            .appendTo("body");
                        $("#dynamicNaviForm").postPop($.action.common.popup("basicPlannerSearch"), "basicPlannerSearchPopup", "width=1300,height=600,left=10,top=10");
                        $("#dynamicNaviForm").remove();
                    }
                },
                order : {
