...
public class CommonDefaultDAO {
    ...
    @Autowired
    @Resource(name="sqlSessionConForDlcc")
    private SqlSession sqlSessionConForDlcc;
    ...
    @SuppressWarnings("rawtypes")
    public List selectLisDlcc(String queryID, Map param) {
        List returnList = sqlSessionConForDlcc.selectList(queryID, param);
        if (returnList == null) {
            returnList = new ArrayList();
        }
        return returnList;
    ...
    public SqlSession getSqlSessionConForDlcc() {
        return sqlSessionConForDlcc;
    }
}