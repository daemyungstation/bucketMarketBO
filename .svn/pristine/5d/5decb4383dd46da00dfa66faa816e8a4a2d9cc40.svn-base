                        ...
                        <table cellspacing="0" class="table-row table-a">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input type="text" class="text xlarge" name="AUT_MST_NM" id="AUT_MST_NM" maxlength="40" value="<c:out value="${row.AUT_MST_NM }"/>" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="radio" id="AUT_MST_VDR_YN1" name="AUT_MST_VDR_YN" value="N" class="radio" <c:if test="${row.AUT_MST_VDR_YN eq 'N' }">checked="checked"</c:if>  />
                                        <label for="AUT_MST_VDR_YN1">관리자</label>
                                        <input type="radio" id="AUT_MST_VDR_YN2" name="AUT_MST_VDR_YN" value="Y" class="radio" <c:if test="${row.AUT_MST_VDR_YN eq 'Y' }">checked="checked"</c:if> />
                                    ...
                                    <td>
                                        <input type="radio" id="AUT_MST_STATE1" name="AUT_MST_STATE" value="Y" class="radio" <c:if test="${row.AUT_MST_STATE eq 'Y' }">checked="checked"</c:if> />
                                        <label for="AUT_MST_STATE1">사용</label>
                                        <input type="radio" id="AUT_MST_STATE2" name="AUT_MST_STATE" value="N" class="radio" <c:if test="${row.AUT_MST_STATE eq 'N' }">checked="checked"</c:if> />
                                ...
                                <tbody id="menuCheckList">
                                    ...
                                    <c:forEach var="row" items="${menuList }" varStatus="i">
                                        ...
                                        <c:if test="${row.ADM_MNU_LEVEL > 0 and row.ADM_MNU_LEVEL eq 1}">
                                            <li class="d1">
                                                <label>
                                                    <input type="checkbox" class="checkbox admin_mnu_depth2" name="ADM_ADM_MNU_IDX" value="<c:out value="${row.ADM_MNU_IDX }"/>" <c:if test="${row.ADM_MNU_CHECK_YN eq 'Y' }">checked="checked"</c:if> />
                                                    <c:out value="${row.ADM_MNU_NM }" />
                                                </label>
                                        </c:if>
                                        <c:if test="${row.ADM_MNU_LEVEL > 0 and row.ADM_MNU_LEVEL eq 2}">
                                            <li class="d2">
                                                <label>
                                                    <input type="checkbox" class="checkbox admin_mnu_depth3" name="ADM_ADM_MNU_IDX" value="<c:out value="${row.ADM_MNU_IDX }"/>" <c:if test="${row.ADM_MNU_CHECK_YN eq 'Y' }">checked="checked"</c:if> />
                                                    <c:out value="${row.ADM_MNU_NM }" />
                                                </label>
                                        </c:if>
