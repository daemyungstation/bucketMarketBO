...
<%@ page import="common.util.AesCrypto" %>
<!DOCTYPE html>
            ...
            <div id="contents">
                ...
                <div class="container">
                    ...
                    <form id="frm" name="frm">
                        ...
                        <input type="hidden" name="searchPrdMstPrpYn" value="<c:out value="${commandMap.searchPrdMstPrpYn }"/>"/>
                                        ...
                                        <c:forEach var="row" items="${list }" varStatus="i">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="https://www.bucketmarket.co.kr/fr/product/basicProductView.do?PRD_MST_NO=${row.PRD_MST_NO }&PRD_MST_ADMIN=${AesCrypto.hashBcrypt(row.PRD_MST_NO)}" target="_blank">
