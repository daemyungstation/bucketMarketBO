                    ...
                    <form id="frm" name="frm">
                        ...
                        <table cellspacing="0" class="table-row table-a">
                            ...
                            <tbody>
                                ...
                                <tr class="prev-tr" <c:if test="${commandMap.CMN_COM_IDX ne Code.TERM_BUCKET_MARKET_USE and info.CMN_COM_IDX ne Code.TERM_PERSONAL_INFORMATION_CODE}">style="display: none;"</c:if>>
                                    <th>
                                        <span>이전약관</span>
                                    </th>
                                    <td>
        ...
        $(function() {
            ...
            $wrapper.on("change", "#AGR_MST_TYPE", function() {
                ...
                if (value == "<c:out value="${Code.TERM_PERSONAL_INFORMATION_CODE }"/>" || value == "<c:out value="${Code.TERM_READY_PLANNER_CODE }"/>") {
                    ...
                    if (value == "<c:out value="${Code.TERM_PERSONAL_INFORMATION_CODE }"/>") {
            ...
            $wrapper.on("change", "#AGR_MST_GBN", function() {
                ...
                var value = $this.val(),
                    array = [ "<c:out value="${Code.TERM_CONTRACT_CONFIRM_FIRST_A}"/>",
                        ...
                        "<c:out value="${Code.TERM_CONTRACT_CONFIRM_FIRST_E}"/>"
                    ];
                $frm.find("#AGR_MST_PRD_NO").remove();
