...
public class StringUtil {
     ...
     * @return
     */
    public static int getInt(Map<String, Object> commandMap, String key) {
        try {
     ...
     * @return
     */
    public static String getString(Map<String, Object> commandMap, String key) {
        try {
