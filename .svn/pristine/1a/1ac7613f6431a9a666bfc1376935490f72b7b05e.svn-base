                                            ...
                                            <c:forEach var="row" items="${list }" varStatus="i">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <c:if test="${(row.ORD_MST_VDR_APV eq Code.RENTAL_TM)||(row.ORD_MST_VDR_APV eq Code.RENTAL_READY)||(row.ORD_MST_VDR_APV eq Code.RENTAL_NO)||(row.ORD_MST_VDR_APV eq Code.RENTAL_NOTPLACE) }">
                                                            <BR>
                                                    ...
                                                    <td>
                                                        <c:if test="${empty row.KSTBIT }">
                                                                                                       접수
                                                        </c:if>
                                                        <c:if test="${not empty row.KSTBIT }">
