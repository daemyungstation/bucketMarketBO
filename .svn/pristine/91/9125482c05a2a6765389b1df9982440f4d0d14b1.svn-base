...
public class BannerDisplayServiceImpl implements BannerDisplayService {
     ...
     * 2. ClassName  : BannerDisplayServiceImpl.java
     * 3. Comment    : 관리자 > 전시관리 > 전시배너관리 > 상품 카테고리 목록
     * 4. 작성자       : inuscommunity
     * 5. 작성일       : 2021. 1. 27.
     * </pre>
     *
     * @see web.bo.display.service.BannerDisplayService#selectProductCategoryList(java.util.Map)
     * @param commandMap
     * @return
     * @throws Exception
     */
    @SuppressWarnings("unchecked")
    public List<Map<String, Object>> selectProductCategoryList(Map<String, Object> commandMap) throws Exception {
        return defaultDAO.selectList("BannerDisplay.selectProductCategoryList", commandMap);
    }
}
