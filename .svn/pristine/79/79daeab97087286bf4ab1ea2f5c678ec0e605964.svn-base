...
public class CommonController {
    ...
    /**
     * <pre>
     * 1. MethodName : pingAjax
     * 2. ClassName  : CommonController.java
     * 3. Comment    : 세션 유지용 ping
     * 4. 작성자       : upleat
     * 5. 작성일       : 2020. 3. 24.
     * </pre>
     *
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/bo/common/PingAjax.do")
    public JSON pingAjax(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
        JSON json = new JSON();
