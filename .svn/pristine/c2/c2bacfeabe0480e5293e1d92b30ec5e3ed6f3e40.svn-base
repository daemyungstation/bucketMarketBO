            ...
            <div class="box-main-login">
                    <form name="frm" id="frm">
                        ...
                        <div class="box-form">
                            ...
                            <input type="hidden" name="clearDormancy" id="clearDormancy" value="<c:out value="${commandMap.clearDormancy}"/>" />
                            <input type="text" name="ADM_MST_ID" id="ADM_MST_ID" value="<c:out value="${commandMap.ADM_MST_ID }"/>" placeholder="아이디" maxlength="10" />
                            <input type="password" name="ADM_MST_PWD" id="ADM_MST_PWD" placeholder="비밀번호" maxlength="20" />
                        </div>
                    </form>
    ...
    <footer class="area-footer">
        <div class="area-inner">
            ...
            <div class="cert">
                ...
                <a href="javascript:window.open('https://www.ucert.co.kr/trustlogo/sseal_cert.html?sealnum=0229c08d76e8747a1f546f8a4c7b8613849d7f054f6fb5899af9ef26f4db9fc5&sealid=6c4f563c32e6ef345de07e95d5f6dee7b5bc67bf7a9d3341dcda56841b136a263304c4701bc88ee704011b56f693dd0d','mark','scrollbars=no,resizable=no,width=565,height=805');">
                    <img src="/resources/img/kisia.png"  align="absmiddle" style="cursor:hand; width: 71.74px; height:40px; padding-top: 5px; border: none;">
                </a>
                <!--KISA Certificate Mark-->
                <a class="" href="javascript:window.open('https://www.daemyungimready.com/ism-popup/ismsp.do','window','width=810, height=1050, left=0, top=0, scrollbars=0, resizable=no')">
                    <img src="/resources/img/isms_p.png" alt="ISMS-P 인증 달성">
                </a>
            </div>
        </div>
    </footer>
