                ...
                <div class="container">
                    ...
                    <div class="tab-list">
                        <ul>
                            ...
                            <li class="col col-1-5 in" style="width: 18%"><a href="javascript:;" class="term-type-tab text-center" data-tab_type="ProductCategory"><span>카테고리</span></a></li>
                        </ul>
                    </div>
                                ...
                                <c:forEach var="row" items="${list }" varStatus="stat">
                                    <c:if test="${not stat.last }">
                                        <tr>
                                            ...
                                            <td><c:out value="${row.ONE_PRD_CTG_NM }"/></td>
                                            <td><c:out value="${row.TWO_PRD_CTG_NM }"/></td>
    ...
    <script>
        $(function() {
            ...
            $wrapper.on("click", "#search", function() {
                ...
                $searchForm.postSubmit($.action.view("ProductCategory", "statsJoinAnalysis"));
            });
            <%-- 엑셀 다운로드 --%>
            $wrapper.on("click", "#goExcelDownload", function() {
                $frm.postSubmit($.action.exceldownload("ProductCategory", "statsJoinAnalysis"));
            });
        });
    </script>
</body>
