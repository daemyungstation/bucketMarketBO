                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <input type="text" name="PLN_MST_ST_DT" id="PLN_MST_ST_DT" class="text date" value="" data-target-end="#PLN_MST_ED_DT" />
                                        ...
                                        <input type="text" name="PLN_MST_ED_DT" id="PLN_MST_ED_DT" class="text date" value="" data-target-start="#PLN_MST_ST_DT" />
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input type="text" name="PLN_MST_TITLE" id="PLN_MST_TITLE" class="text xlarge" value="" maxlength="40" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="radio" name="PLN_MST_RPL_YN" id="PLN_MST_RPL_YN0" value="Y" class="radio" checked="checked" />
                                        <label for="PLN_MST_RPL_YN0">사용</label>
                                        <input type="radio" name="PLN_MST_RPL_YN" id="PLN_MST_RPL_YN1" value="N" class="radio" />
                                    ...
                                    <td>
                                        <input type="radio" name="PLN_MST_USE_YN" id="PLN_MST_USE_YN0" value="Y" class="radio" checked="checked" />
                                        <label for="PLN_MST_USE_YN0">사용</label>
                                        <input type="radio" name="PLN_MST_USE_YN" id="PLN_MST_USE_YN1" value="N" class="radio" />
                                ...
                                <tr>
                                    <th>
                                        <label class="label">
                                            <span>댓글 노출여부<i class="require"><em>필수입력</em></i></span>
                                        </label>
                                    </th>
                                    <td>
                                        <input type="radio" name="PLN_MST_RPL_EXP_YN" id="PLN_MST_RPL_EXP_YN0" value="Y" class="radio" checked="checked" />
                                        <label for="PLN_MST_RPL_EXP_YN0">사용</label>
                                        <input type="radio" name="PLN_MST_RPL_EXP_YN" id="PLN_MST_RPL_EXP_YN1" value="N" class="radio" />
                                        <label for="PLN_MST_RPL_EXP_YN1">사용안함</label>
                                    </td>
                                    <th>
                                        <label class="label">
                                    ...
                                    <td>
                                        <input type="radio" name="PLN_MST_PRD_DPL_YN" id="PLN_MST_PRD_DPL_YN0" value="Y" class="radio" checked="checked" />
                                        <label for="PLN_MST_PRD_DPL_YN0">사용</label>
                                        <input type="radio" name="PLN_MST_PRD_DPL_YN" id="PLN_MST_PRD_DPL_YN1" value="N" class="radio" />
                                ...
                                <tr>
                                    ...
                                    <td colspan = "3">
                                        <input type="radio" name="PLN_MST_PSN_YN" id="PLN_MST_PSN_YN0" value="Y" class="radio" checked="checked"  />
                                        <label for="PLN_MST_PSN_YN0">사용</label>
                                        <input type="radio" name="PLN_MST_PSN_YN" id="PLN_MST_PSN_YN1" value="N" class="radio"/>
                                        <label for="PLN_MST_PSN_YN1">사용안함</label>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                <c:forEach var="device" items="${Const.DEVICE }" varStatus="i">
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="textarea" name="<c:out value="${device.key eq Const.PC ? 'PLN_MST_PC_MDA' : 'PLN_MST_MB_MDA' }"/>" id="<c:out value="${device.key eq Const.PC ? 'PLN_MST_PC_MDA' : 'PLN_MST_MB_MDA' }"/>" style="height: 500px; width: 100%"></textarea>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                            ...
                            <tbody>
                                <c:forEach var="device" items="${Const.DEVICE }" varStatus="i">
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="textarea" name="<c:out value="${device.key eq Const.PC ? 'PLN_MST_PC_DTL' : 'PLN_MST_MB_DTL' }"/>" id="<c:out value="${device.key eq Const.PC ? 'PLN_MST_PC_DTL' : 'PLN_MST_MB_DTL' }"/>" style="height: 500px; width: 100%"></textarea>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
