                        ...
                        <table cellspacing="0" class="table-row table-a">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="PRD_MST_RDP_CMS_CD" id="PRD_MST_RDP_CMS_CD" class="text onlyNumber" value="" readonly/>
...
각 검색단어는 쉼표(,) 로 구분하며, 공백도 검색어에 포함됩니다.(특수문자 제외)" maxlength="2000"></textarea>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <span>총수수료금액 :</span>
                                        <input type="text" name="PRD_MST_RDP_CMS" id="PRD_MST_RDP_CMS" class="text onlyNumber" value="" maxlength="10"/>
                                        &nbsp;&nbsp;
                                        <span>분할금액 :</span>
                                        <input type="text" name="PRD_MST_RDP_DVD_PAY" id="PRD_MST_RDP_DVD_PAY" class="text onlyNumber" value="" maxlength="10"/>
                                        &nbsp;&nbsp;
                                        <span>분할회차 :</span>
                                        <input type="text" name="PRD_MST_RDP_DVD_CNT" id="PRD_MST_RDP_DVD_CNT" class="text onlyNumber" value="" maxlength="10"/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
    ...
    <script id="productTypeTemplate" type="text/x-jquery-tmpl">
        ...
        {{else PRD_MST_TYPE == "<c:out value="${Code.PRODUCT_TYPE_RENTAL}"/>"}}
            ...
            <input type="text" name="PRD_MST_RTL_PAY" id="PRD_MST_RTL_PAY" class="text onlyNumber" placeholder="기본월부금(숫자만입력)" value="" />
        {{/if}}
    </script>
    <script>
        $(function() {
