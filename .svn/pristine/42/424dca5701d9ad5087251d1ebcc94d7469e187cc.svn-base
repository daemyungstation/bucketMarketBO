...
public class PlannerCounsellController {
     ...
     * @throws Exception
     */
    @RequestMapping(value = "bo/planner/plannerCounsellList")
    public ModelAndView plannerCounsellList(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
        ...
        commandMap.put("authMstIdx", SessionsManager.getSessionValue("AUT_MST_IDX"));
        ...
        mv.setViewName("bo/planner/plannerCounsellList");
        return mv;
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value = "bo/planner/plannerCounsellExcelDownload")
    public EXCEL plannerCounsellExcelDownload(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
        ...
        if (list != null) {
            excel.put("fileName", "daemyung_planner_counsell_" + DateUtil.getCurrentDateTime());
    ...
    @RequestMapping(value = "bo/planner/plannerCounsellUpdateDataAjax")
     ...
     * @throws Exception
     */
    @RequestMapping(value = "bo/common/popup/memoPopup")
    public ModelAndView plannerCalculateHistoryListPopup(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
        ModelAndView mv = new ModelAndView();
        // 목록 개수
        int totalCount = this.plannerCounsellService.selectCounsellHistoryListCount(commandMap);
        ...
        List<Map<String, Object>> list = null;
        if (totalCount > 0) {
            list = this.plannerCounsellService.selectCounsellHistoryList(commandMap);
        }
        ...
        mv.setViewName("bo/planner/plannerCounsellHistoryListPopup");
        return mv;
    }
