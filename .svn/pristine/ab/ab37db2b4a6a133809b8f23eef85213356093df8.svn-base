                        ...
                        <table cellspacing="0" class="table-row table-a">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="PRD_MST_SPL_NM" id="PRD_MST_SPL_NM" class="text xlarge" value="" maxlength="50" />
                                    </td>
                                    <th>
                                        <label class="label">
                                    ...
                                    <td>
                                        <input type="text" name="PRD_MST_MD" id="PRD_MST_MD" class="text xlarge" value="" maxlength="20" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td colspan="3">
                                        <input type="text" name="PRD_MST_SPL_PRC" id="PRD_MST_SPL_PRC" class="text xlarge onlyNumber" value="0" maxlength="10" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td colspan="3">
                                        <div class="wrap text-left">
                                            ...
                                            <label for="PRD_MST_OPT_YN0">
                                                <input type="radio" name="PRD_MST_OPT_YN" id="PRD_MST_OPT_YN0" class="radio" value="Y"/>
                                                <span>사용함</span>
                                            </label>
                                            <label for="PRD_MST_OPT_YN1">
                                                <input type="radio" name="PRD_MST_OPT_YN" id="PRD_MST_OPT_YN1" class="radio" value="N" checked="checked"/>
                                                <span>사용안함</span>
                                            </label>
                                            <span class="product-option-area"></span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <div class="wrap text-left">
                                            <label for="PRD_MST_PRP_YN0">
                                                <input type="radio" name="PRD_MST_PRP_YN" id="PRD_MST_PRP_YN0" class="radio" value="Y"/>
                                                <span>사용함</span>
                                            </label>
                                            <label for="PRD_MST_PRP_YN1">
                                                <input type="radio" name="PRD_MST_PRP_YN" id="PRD_MST_PRP_YN1" class="radio" value="N" checked="checked"/>
                                                <span>사용안함</span>
                                            </label>
                                        </div>
                                    </td>
                                </tr>
<%--                                <span class="product-prp-area">--%>
...
<%--                                </span>--%>
                        ...
                        <div id="tab" class="tab-list">
                            <ul>
                                ...
                                <%-- <c:if test="${commandMap.AUT_MST_IDX }.equlas()"></c:if> --%>
                                    ...
                                    <div class="edit-product-image">
                                        <div class="default">
                                            ...
                                            <div class="grid main-img">
                                                <div class="col thumb">
                                                    <a href="javascript:;">
                                                        <img src="<spring:eval expression="@resource['img.ssl.domain']"/>/resources/img/blank.png" class="pic"/>
                                                    </a>
                                                    <div class="section-button action">
                                                        <input type="file" class="product-image-file" name="<c:out value="${Product.IMG_MAIN_NM }"/>" style="display: none;"/>
                                        ...
                                        <div class="optional">
                                            ...
                                            <div class="grid img-list">
                                                <c:forEach var="productSubImageNm" items="${Product.IMG_SUB_NMS }">
                                                    <div class="col module">
                                                        ...
                                                        <div class="section-button action">
                                                            <input type="file" class="product-image-file" name="<c:out value="${productSubImageNm }"/>" style="display: none;"/>
                                                            <a href="javascript:;" class="button small product-image-file-add"><span>파일 찾기</span></a>
                                                        </div>
                                                    </div>
                                                </c:forEach>
                                        ...
                                        <div class="optional">
                                            ...
                                            <div class="grid img-list">
                                                <textarea name="PRD_MST_RDP_TXT" id="PRD_MST_RDP_TXT" class="textarea xlarge" style="height: 100px; width: 100%;" maxlength="500"></textarea>
                                            </div>
                                        </div>
                                        --%>
                                    </div>
                                    ...
                                    <table cellspacing="0" class="table-row table-a">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea class="textarea" name="PRD_MST_NTC_DSC" id="PRD_MST_NTC_DSC" editor="true"></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
                                                ...
                                                <td>
                                                    <textarea class="textarea" name="PRD_MST_DLV_DSC" id="PRD_MST_DLV_DSC" editor="true"></textarea>
                                                </td>
                                            </tr>                                                
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            <c:forEach var="device" items="${Const.DEVICE }" varStatus="i">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea class="textarea" name="<c:out value="${device.key eq Const.PC ? 'PRD_MST_PC_YTB' : 'PRD_MST_MB_YTB' }"/>" id="<c:out value="${device.key eq Const.PC ? 'PRD_MST_PC_YTB' : 'PRD_MST_MB_YTB' }"/>"  editor="true"></textarea>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                        ...
                                        <tbody>
                                            <c:forEach var="device" items="${Const.DEVICE }" varStatus="i">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea class="textarea" name="<c:out value="${device.key eq Const.PC ? 'PRD_MST_PC_DTL_DSC' : 'PRD_MST_MB_DTL_DSC' }"/>" id="<c:out value="${device.key eq Const.PC ? 'PRD_MST_PC_DTL_DSC' : 'PRD_MST_MB_DTL_DSC' }"/>" editor="true"></textarea>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${not empty productNfiList}">
                                                                <c:forEach var="productNfiList" items="${productNfiList }" varStatus="status">
                                                                    <option value="<c:out value="${productNfiList.PRD_NFI_IDX }" />"><c:out value="${productNfiList.PRD_NFI_NM }" /></option>
                                                                </c:forEach>
                                                            </c:when>
                                                        </c:choose>
                                                    </select>
                                                    <label for="detailReferenceToggle"><input type="checkbox" id="detailReferenceToggle" class="checkbox" disabled="disabled"/>상세설명 참조 일괄입력</label>
                                                </td>
                                            </tr>
                                            <tr>
    ...
    <script id="productOptionTemplate" type="text/x-jquery-tmpl">
        <table cellspacing="0" class="table-row table-b">
            ...
            <tbody class="option-tbody">
                <tr>
                    <td rowspan="5"><input type="text" name="PRD_MST_OPT_NM" id="PRD_MST_OPT_NM" class="text xlarge" value="" maxlength="20" /></td>
    ...
    <script id="productPRPTemplate" type="text/x-jquery-tmpl">
        <tr>
            <th>
                <span>등록 래디플러너<i class="require"><em>필수입력</em></i></span>
            </th>
            <td>
    ...
    <script>
        $(function() {
            ...
            var $productOptionArea = $frm.find(".product-option-area"),
                $productOptionTemplate = $("#productOptionTemplate"),
            ...
            <%-- 옵션 사용여부 라디오 버튼 변경 이벤트 --%>
            $frm.on("change", "input[name='PRD_MST_OPT_YN']", function () {
                var $this = $(this);
                if ($this.val() == "N") {
                    $productOptionArea.empty();
                } else {
                    $productOptionTemplate.tmpl().appendTo($productOptionArea);
                }
            });
            ...
            $frm.on("click", ".product-image-file-add", function () {
                $(this).siblings(".product-image-file").trigger("click");
            });
            <%-- 파일변경 이벤트 --%>
