                        ...
                        <table cellspacing="0" class="table-row table-a">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="PRC_RDP_CMS_CD" id="PRC_RDP_CMS_CD" class="text onlyNumber" value="<c:out value="${union.PRC_RDP_CMS_CD }"/>" disabled="disabled"/>
                                    </td>
                                    <th>
                                        <label class="label">
                                    ...
                                    <td>
                                        <input type="text" name="PRC_RDP_P_CMS_CD" id="PRC_RDP_P_CMS_CD" class="text onlyNumber" value="<c:out value="${union.PRC_RDP_P_CMS_CD }"/>" disabled="disabled"/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table cellspacing="0" class="table-row table-a">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <div class="wrap text-left">
                                            <label for="PRD_MST_REC_TXT_YN0">
                                                <input type="radio" name="PRD_MST_REC_TXT_YN" id="PRD_MST_REC_TXT_YN0" class="radio" value="Y" <c:if test="${union.PRD_MST_REC_TXT_YN eq 'Y' }">checked="checked"</c:if> />
                                                <span>사용함</span>
                                            </label>
                                            <label for="PRD_MST_REC_TXT_YN1">
                                                <input type="radio" name="PRD_MST_REC_TXT_YN" id="PRD_MST_REC_TXT_YN1" class="radio" value="N" <c:if test="${union.PRD_MST_REC_TXT_YN eq 'N' }">checked="checked"</c:if> />
                                                <span>사용안함</span>
                                            </label>
                                        </div>
                                    </td>
...
각 검색단어는 쉼표(,) 로 구분하며, 공백도 검색어에 포함됩니다.(특수문자 제외)" maxlength="2000"><c:out value="${union.PRD_MST_KWD }"/></textarea>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <c:if test="${union.PRD_MST_BND_YN eq 'N' }">
                                            <label for="PRD_MST_BND_YN1">
                                                ...
                                                <br><br>
                                                <input type="text" name="PRD_MST_BND_ID" id="PRD_MST_BND_ID" class="text" value="<c:out value="${union.PRD_MST_BND_ID }"/>" maxlength="40"/> 
                                ...
                                <tr>
                                    ...
                                    <c:if test="${union.PRD_MST_TYPE eq Code.PRODUCT_TYPE_MONTHLY_SUPPORT }">
                                        <span>월지원 </span>
                                        <input type="text" name="PRD_MST_SPT_TXT" id="PRD_MST_SPT_TXT" class="text" placeholder="Ex) 월 3만원 지원" value="<c:out value="${union.PRD_MST_SPT_TXT }"/>" maxlength="40"/>
                                    </c:if>
                                    <c:if test="${union.PRD_MST_TYPE eq Code.PRODUCT_TYPE_IMMEDIATELY_ISSUE }">
                                        <span>즉발 </span>
                                        <input type="text" name="PRD_MST_SPT_TXT" id="PRD_MST_SPT_TXT" class="text" placeholder="Ex) 신혼가전 전액지원" value="<c:out value="${union.PRD_MST_SPT_TXT }"/>" maxlength="40"/>
                                    </c:if>
                                    <c:if test="${union.PRD_MST_TYPE eq Code.PRODUCT_TYPE_MONTHLY_INSTALLMENT_PLAN }">
                                        ...
                                        <input type="checkbox" name="PRD_MST_ISTM_MTH" id="PRD_MST_ISTM_MTH18/>" <c:forTokens var="qutabase" items="${union.PRD_MST_ISTM_MTH }" delims=":"><c:if test="${qutabase eq 18 }">checked="checked"</c:if></c:forTokens> value="18" disabled="disabled"/>
                                    ...
                                    <c:if test="${union.PRD_MST_TYPE eq Code.PRODUCT_TYPE_RENTAL }">
                                        <span>렌탈 </span>
                                        <input type="text" name="PRD_MST_SPT_TXT" id="PRD_MST_SPT_TXT" class="text" placeholder="Ex) 월 2만원 지원" value="<c:out value="${union.PRD_MST_SPT_TXT }"/>" maxlength="40"/>
                                        <input type="text" name="PRD_MST_RTL_PAY" id="PRD_MST_RTL_PAY" class="text onlyNumber" placeholder="기본월부금(숫자만입력)" value="<c:out value="${union.PRD_MST_RTL_PAY }"/>"/>
                                    </c:if>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        &nbsp;&nbsp;                                        &nbsp;&nbsp;
                                        <span>총수수료금액 :</span>
                                        <input type="text" name="PRC_RDP_CMS" id="PRC_RDP_CMS" class="text onlyNumber" value="<fmt:formatNumber value="${union.PRC_RDP_CMS }" type="number" />"/>
                                        &nbsp;&nbsp;
                                        <span>분할금액 :</span>
                                        <input type="text" name="PRC_RDP_DVD_PAY" id="PRC_RDP_DVD_PAY" class="text onlyNumber" value="<fmt:formatNumber value="${union.PRC_RDP_DVD_PAY }" type="number" />"/>
                                        &nbsp;&nbsp;
                                        <span>분할회차 :</span>
                                ...
                                <tr>
                                    <td colspan="3">
                                        ...
                                        &nbsp;&nbsp;                                        &nbsp;&nbsp;
                                        <span>총수수료금액 :</span>
                                        <input type="text" name="PRC_RDP_P_CMS" id="PRC_RDP_P_CMS" class="text onlyNumber" value="<fmt:formatNumber value="${union.PRC_RDP_P_CMS }" type="number" />"/>
                                        &nbsp;&nbsp;
                                        <span>분할금액 :</span>
                                        <input type="text" name="PRC_RDP_P_DVD_PAY" id="PRC_RDP_P_DVD_PAY" class="text onlyNumber" value="<fmt:formatNumber value="${union.PRC_RDP_P_DVD_PAY }" type="number" />"/>
                                        &nbsp;&nbsp;
                                        <span>분할회차 :</span>
                                        <input type="text" name="PRC_RDP_P_DVD_CNT" id="PRC_RDP_P_DVD_CNT" class="text onlyNumber" value="<fmt:formatNumber value="${union.PRC_RDP_P_DVD_CNT }" type="number" />"/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
    ...
    <script>
        $(function() {
            ...
            $wrapper.on("click", "#save", function() {
                ...
                $("#PRC_RDP_CMS").val($("#PRC_RDP_CMS").val().replace(",", ""));
                $("#PRC_RDP_DVD_PAY").val($("#PRC_RDP_DVD_PAY").val().replace(",", ""));

                $("#PRC_RDP_P_CMS").val($("#PRC_RDP_P_CMS").val().replace(",", ""));
                $("#PRC_RDP_P_DVD_PAY").val($("#PRC_RDP_P_DVD_PAY").val().replace(",", ""));
                if ($frm.valid()) {
                    if (confirm("저장 하시겠습니까?")) {
