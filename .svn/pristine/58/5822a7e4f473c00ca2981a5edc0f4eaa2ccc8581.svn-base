...
public class EditorTag extends TagSupport {
    ...
    public String resultView(String objId, String jsLoadYn, String height, String btn1, String btn2, String num) throws JspException {
        ...
        if ("Y".equals(jsLoadYn)) {
            sb.append("<script type=\"text/javascript\" src=\"/resources/smartEditor/js/HuskyEZCreator.js\" charset=\"utf-8\"></script>");
            sb.append("<script type=\"text/javascript\" src=\"/resources/smartEditor/js/smarteditor.custom.js\" charset=\"utf-8\"></script>");
        }
        ...
        sb.append("sSkinURI: \"/resources/smartEditor/SmartEditor2Skin.html\",\n");
        sb.append("htParams : {\n");
        sb.append("bUseToolbar : true,\n");
        sb.append("bUseVerticalResizer : true,\n");
        sb.append("bUseModeChanger : true,\n");
        sb.append("//aAdditionalFontList : aAdditionalFontSet,\n"); // 추가 글꼴 목록
