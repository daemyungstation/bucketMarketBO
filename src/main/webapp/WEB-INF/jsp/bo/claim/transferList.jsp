                                        ...
                                        <c:when test="${not empty list }">
                                            <c:forEach var="row" items="${list }" varStatus="i">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ui:formatDate value="${row.CLM_TRS_REG_DT }" pattern="yyyy.MM.dd" />
                                                    </td>
                                                    <td>
                                                        <select name="CMN_COM_IDX" class="select half" data-clm_trs_idx="<c:out value="${row.CLM_TRS_IDX }"/>">
                                                            <c:if test="${not empty codeList }">
            ...
            $wrapper.on("click", ".save", function() {
                if (confirm("저장 하시겠습니까?")) {
                    ...
                    $target.each(function () {
                        var $this = $(this);
                        param.CLM_TRS_IDX = $this.data("clm_trs_idx");
