            ...
            <div class="modal-inner">
                ...
                <div class="tab-list">
                    <ul>
                        ...
                        <li class="in">
                            <a href="javascript:;" class="term-type-tab"><span>실적</span></a>
                        </li>
                        <li>
                            <a href="javascript:;" class="term-type-tab" id="tabPayment"><span>지급</span></a>
                        </li>
                    </ul>
                </div>
                    ...
                    <table cellspacing="0" class="table-row table-a" style="margin-bottom: 0;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" name="searchOnlineProductCode" id="searchOnlineProductCode" class="text large" value="<c:out value="${commandMap.searchOnlineProductCode }"/>" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="grid section-button-search">
                    ...
                    <form id="frm" name="frm">
                        ...
                        <input type="hidden" name="searchOnlineProductCode" value="<c:out value="${commandMap.searchOnlineProductCode }"/>" />
                                    ...
                                    <c:when test="${not empty list}">
                                        <c:forEach var="row" items="${list }" varStatus="i">
                                            <tr>
                                                ...
                                                <td>
                                                    <fmt:formatNumber value="${row.PRD_MST_RDP_DVD_PAY * row.PRD_MST_RDP_DVD_CNT }" type="number"/>원 (<fmt:formatNumber value="${row.PRD_MST_RDP_DVD_PAY }" type="number"/>원 * <fmt:formatNumber value="${row.PRD_MST_RDP_DVD_CNT }" type="number"/>회)
                                                </td>
                                                <td>
    ...
    <script>
        $(function () {
            ...
            $popup.on("click", "#search", function() {
                ...
                $searchForm.postSubmit($.action.popup("Performance"));
            });
            // 페이지 이동
            goPage = function(cPage) {
                $frm.find("input[name='cPage']").val(cPage);
                $frm.postSubmit($.action.popup("Performance"));
            };
            // 엑셀 다운로드
            $popup.on("click", "#goExcelDownload", function() {
                $frm.postSubmit($.action.exceldownload("Performance"));
            });
        });
    </script>
</body>
