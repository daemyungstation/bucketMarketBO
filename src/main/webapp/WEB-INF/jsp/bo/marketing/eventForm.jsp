                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <input type="text" name="EVT_MST_ST_DT" id="EVT_MST_ST_DT" class="text date" value="" data-target-end="#EVT_MST_ED_DT" />
                                        ...
                                        <input type="text" name="EVT_MST_ED_DT" id="EVT_MST_ED_DT" class="text date" value="" data-target-start="#EVT_MST_ST_DT" />
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input type="text" name="EVT_MST_TITLE" id="EVT_MST_TITLE" class="text xlarge" value="" maxlength="40" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="radio" name="EVT_MST_RPL_YN" id="EVT_MST_RPL_YN0" value="Y" class="radio" checked="checked" />
                                        <label for="EVT_MST_RPL_YN0">사용</label>
                                        <input type="radio" name="EVT_MST_RPL_YN" id="EVT_MST_RPL_YN1" value="N" class="radio" />
                                    ...
                                    <td>
                                        <input type="radio" name="EVT_MST_IMG_YN" id="EVT_MST_IMG_YN0" value="Y" class="radio" checked="checked" />
                                        <label for="EVT_MST_IMG_YN0">사용</label>
                                        <input type="radio" name="EVT_MST_IMG_YN" id="EVT_MST_IMG_YN1" value="N" class="radio" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="EVT_MST_PSN_YN" id="EVT_MST_PSN_YN0" value="Y" class="radio" checked="checked" />
                                        <label for="EVT_MST_PSN_YN0">수집</label>
                                        <input type="radio" name="EVT_MST_PSN_YN" id="EVT_MST_PSN_YN1" value="N" class="radio" />
                                    ...
                                    <td>
                                        <input type="radio" name="EVT_MST_USE_YN" id="EVT_MST_USE_YN0" value="Y" class="radio" checked="checked" />
                                        <label for="EVT_MST_USE_YN0">사용</label>
                                        <input type="radio" name="EVT_MST_USE_YN" id="EVT_MST_USE_YN1" value="N" class="radio" />
                            ...
                            <tbody>
                                <c:forEach var="device" items="${Const.DEVICE }" varStatus="i">
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="textarea" name="<c:out value="${device.key eq Const.PC ? 'EVT_MST_PC_MDA' : 'EVT_MST_MB_MDA' }"/>" id="<c:out value="${device.key eq Const.PC ? 'EVT_MST_PC_MDA' : 'EVT_MST_MB_MDA' }"/>" style="height: 500px; width: 100%"></textarea>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                            ...
                            <tbody>
                                <c:forEach var="device" items="${Const.DEVICE }" varStatus="i">
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="textarea" name="<c:out value="${device.key eq Const.PC ? 'EVT_MST_PC_DTL' : 'EVT_MST_MB_DTL' }"/>" id="<c:out value="${device.key eq Const.PC ? 'EVT_MST_PC_DTL' : 'EVT_MST_MB_DTL' }"/>" style="height: 500px; width: 100%"></textarea>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
