                        ...
                        <table cellspacing="0" class="table-row table-a">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="PLN_MST_RPL_EXP_YN" id="PLN_MST_RPL_EXP_YN0" value="Y" class="radio" <c:if test="${info.PLN_MST_RPL_EXP_YN eq 'Y' }">checked="checked"</c:if>/>
                                        <label for="PLN_MST_RPL_EXP_YN0">사용</label>
                                        <input type="radio" name="PLN_MST_RPL_EXP_YN" id="PLN_MST_RPL_EXP_YN1" value="N" class="radio" <c:if test="${info.PLN_MST_RPL_EXP_YN eq 'N' }">checked="checked"</c:if>/>
                                ...
                                <tr>
                                    ...
                                    <td colspan = "3">
                                        ...
                                        <input type="radio" name="PLN_MST_PSN_YN" id="PLN_MST_PSN_YN0" value="Y" class="radio" <c:if test="${info.PLN_MST_PSN_YN eq 'Y' }">checked="checked"</c:if>/>
                                        <label for="PLN_MST_PSN_YN0">사용</label>
                                        <input type="radio" name="PLN_MST_PSN_YN" id="PLN_MST_PSN_YN1" value="N" class="radio" <c:if test="${info.PLN_MST_PSN_YN eq 'N' }">checked="checked"</c:if>/>
