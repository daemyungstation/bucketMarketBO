            ...
            <div id="contents">
                <div class="container">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <input type="text" name="searchEvtRplRegStDt" id="searchEvtRplRegStDt" class="text date" value="<c:out value="${commandMap.searchEvtRplRegStDt }" />" data-target-end="#searchEvtRplRegEtDt" />
                                        ~
                                        <a href="javascript:;" class="js-datepickr">
                                            <span class="icon datepickr">
                                                <em>날짜선택</em>
                                        ...
                                        <input type="text" name="searchEvtRplRegEtDt" id="searchEvtRplRegEtDt" class="text date" value="<c:out value="${commandMap.searchEvtRplRegEtDt }" />" data-target-start="#searchEvtRplRegStDt" />
                                        <a href="javascript:DateUtil.fnDateSet('searchEvtRplRegEtDt', 'searchEvtRplRegStDt', 0, 0, 0, 0, 0, 0,  '-');" class="button button-a xsmall">
                                            <span>오늘</span>
                                        </a>
                                        <a href="javascript:DateUtil.fnDateSet('searchEvtRplRegEtDt', 'searchEvtRplRegStDt', 0, 0, 0, 0, 0, -7,  '-');" class="button button-a xsmall">
                                            <span>일주일</span>
                                        </a>
                                        <a href="javascript:DateUtil.fnDateSet('searchEvtRplRegEtDt', 'searchEvtRplRegStDt', 0, 0, 0, 0, 0, -15,  '-');" class="button button-a xsmall">
                                            <span>15일</span>
                                        </a>
                                        <a href="javascript:DateUtil.fnDateSet('searchEvtRplRegEtDt', 'searchEvtRplRegStDt', 0, 0, 0, 0, -1, 0,  '-');" class="button button-a xsmall">
                                            <span>한달</span>
                                        </a>
                                        <a href="javascript:DateUtil.fnDateSet('searchEvtRplRegEtDt', 'searchEvtRplRegStDt', 0, 0, 0, 0, -2, 0,  '-');" class="button button-a xsmall">
                                            <span>두달</span>
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <form id="frm" name="frm">
                        ...
                        <input type="hidden" name="searchEvtMstPsnYn" value="<c:out value="${commandMap.searchEvtMstPsnYn }"/>" />
                        <input type="hidden" name="searchEvtMstUseYn" value="<c:out value="${commandMap.searchEvtMstUseYn }"/>" />
                        <input type="hidden" name="searchEvtRplRegStDt" value="<c:out value="${commandMap.searchEvtRplRegStDt }"/>" />
                        <input type="hidden" name="searchEvtRplRegEtDt" value="<c:out value="${commandMap.searchEvtRplRegEtDt }"/>" />
