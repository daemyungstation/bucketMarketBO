            ...
            <div id="contents">
                <div class="container">
                        ...
                        <table cellspacing="0" class="table-row table-a">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="PRD_MST_SPL_NM" id="PRD_MST_SPL_NM" class="text xlarge" value="<c:out value="${info.PRD_MST_SPL_NM }"/>" maxlength="50" />
                                    </td>
                                    <th>
                                        <label class="label">
                                    ...
                                    <td>
                                        <input type="text" name="PRD_MST_MD" id="PRD_MST_MD" class="text xlarge" value="<c:out value="${info.PRD_MST_MD }"/>" maxlength="20" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td colspan="3">
                                        <input type="text" name="PRD_MST_SPL_PRC" id="PRD_MST_SPL_PRC" class="text xlarge onlyNumber" value="<c:out value="${info.PRD_MST_SPL_PRC }"/>" maxlength="10" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <label for="PRD_MST_OPT_YN0">
                                            <input type="radio" name="PRD_MST_OPT_YN" id="PRD_MST_OPT_YN0" class="radio" value="Y"  <c:if test="${info.PRD_MST_OPT_YN eq 'Y' }">checked="checked"</c:if>/>
                                            <span>사용함</span>
                                        </label>
                                        <label for="PRD_MST_OPT_YN1">
                                            <input type="radio" name="PRD_MST_OPT_YN" id="PRD_MST_OPT_YN1" class="radio" value="N"  <c:if test="${info.PRD_MST_OPT_YN eq 'N' }">checked="checked"</c:if>/>
                                            <span>사용안함</span>
                                        </label>
                                        </div>
                                                        ...
                                                        <c:forEach var="row" items="${productOption }" varStatus="stat">
                                                            <tr>
                                                                <c:if test="${stat.first }">
                                                                    <td rowspan="5">
                                                                        <input type="text" name="PRD_MST_OPT_NM" id="PRD_MST_OPT_NM" class="text xlarge" value="<c:out value="${info.PRD_MST_OPT_NM }"/>" maxlength="20" />
                                                                    </td>
                                                                </c:if>
                                                                <td><input type="text" name="PRD_OPT_DTL" id="PRD_OPT_DTL" class="text xlarge" value="<c:out value="${row.PRD_OPT_DTL }"/>" maxlength="20" /></td>
                                                                <td>
                                                                    <c:if test="${stat.first }">
                                ...
                                <c:if test="${not isScm }">
                                    ...
                                    <c:if test="${not isScm }">
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <label for="PRD_MST_APV_STATE0">
                                                    <input type="radio" name="PRD_MST_APV_STATE" id="PRD_MST_APV_STATE0" class="radio" value="<c:out value="${Product.STATE_APPROVAL}" />" <c:if test="${info.PRD_MST_APV_STATE eq Product.STATE_APPROVAL || info.PRD_MST_APV_STATE eq Product.STATE_DISAPPROVAL}">checked="checked"</c:if>/>
                                                    <span><c:out value="${Product.STATE_APPROVAL_NM}" /></span>
                                                </label>
                                                <label for="PRD_MST_APV_STATE1">
                                                    <input type="radio" name="PRD_MST_APV_STATE" id="PRD_MST_APV_STATE1" class="radio" value="<c:out value="${Product.STATE_REJECT}" />" <c:if test="${info.PRD_MST_APV_STATE eq Product.STATE_REJECT }">checked="checked"</c:if>/>
                                                    <span><c:out value="${Product.STATE_REJECT_NM}" /></span>
                                                </label>
                                            </td>
                                        </tr>
                                    </c:if>
                                    <tr class="rfs-rsn-tr" <c:if test="${info.PRD_MST_APV_STATE ne Product.STATE_REJECT }"> style="display: none;"</c:if>>
                                        <td colspan="3">
                                            <textarea name="PRD_MST_RFS_RSN" id="PRD_MST_RFS_RSN" class="textarea xlarge" style="height: 100px; width: 100%;" maxlength="500"><c:out value="${info.PRD_MST_RFS_RSN }"/></textarea>
                                        </td>
                                    </tr>
                                </c:if>
                                <c:if test="${isScm && info.PRD_MST_APV_STATE eq Product.STATE_REJECT }">
                                    <tr>
                                        <th>
                                            <label class="label">
                                                <span>등록일</span>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <span><c:out value="${info.PRD_MST_RFS_RSN}" /></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                ...
                                <c:if test="${isScm && info.PRD_MST_APV_STATE eq Product.STATE_DISAPPROVAL }">
                                    <tr>
                                        <th>
                                            <label class="label">
                                                <span>등록일</span>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <span><c:out value="${Product.STATE_DISAPPROVAL}" /></span>
                                        </td>
                                    </tr>
                                </c:if>
                            </tbody>
                    ...
                    <div class="section-button">
                        ...
                        <c:if test="${isScm && info.PRD_MST_APV_STATE eq Product.STATE_REJECT }">
                            <a href="javascript:;" id="approval" class="button large primary">
                                <span>승인요청</span>
                            </a>
                        </c:if>
            ...
            $wrapper.on("click", "#approval", function() {
                if ($frm.valid()) {
                    if (confirm("승인요청을 하시겠습니까?")) {
                        $frm.postSubmit($.action.modify("Request"));
                    }
                }
            });
            <%-- 품목정보 등록/수정 폼 --%>
