                        ...
                        <table cellspacing="0" class="table-row table-a">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="BRD_NTS_USE_YN" id="BRD_NTS_USE_YN0" value="Y" class="radio" checked="checked" />
                                        <label for="BRD_NTS_USE_YN0">사용</label>
                                        <input type="radio" name="BRD_NTS_USE_YN" id="BRD_NTS_USE_YN1" value="N" class="radio" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="BRD_NTS_TOP_YN" id="BRD_NTS_TOP_YN" value="Y" class="checkbox" />
                                    ...
                                    <td>
                                        <c:if test="${not empty codeList }">
                                            <c:forEach var="row" items="${codeList }" varStatus="i">
                                                <input type="radio" name="BRD_CMN_COM_IDX" id="BRD_CMN_COM_IDX<c:out value="${i.index }"/>" value="<c:out value="${row.CMN_COM_IDX }"/>" <c:if test="${i.first }">checked="checked"</c:if>/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="BRD_NTS_TITLE" id="BRD_NTS_TITLE" class="text xlarge" placeholder="공지사항 제목입니다." style="width: 80%;" maxlength="40" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <textarea class="textarea" name="BRD_NTS_CONTENTS" id="BRD_NTS_CONTENTS" style="height: 500px; width: 100%"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
