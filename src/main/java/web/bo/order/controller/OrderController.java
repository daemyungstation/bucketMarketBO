...
public class OrderController {
    ...
    public EXCEL orderReceiptExcelDownload(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
        ...
        if (list != null) {
            ...
            excel.put("list", list);
            String [] headerTitle = {"NO",      "주문번호",      "온라인상품명",     "고객명",   "연락처",     "기간계 상품코드", "모델분류",        "지원혜택",          "모델명",     "옵션",         "추가정보",              "회원상태",  "접수일",            "레디플래너 번호", "영업사원", "추천인",  "UTM_SOURCE",  "UTM_MEDIUM",  "UTM_CAMPAIGN",  "UTM_TERM",  "UTM_CONTENT"};
            String [] cellField =   {"RNUM",    "ORD_MST_IDX", "PRD_MST_NM",    "MEM_NM", "CELL",     "PROD_CD",     "MODEL_CL_NM",   "PRD_MST_SPL_NM", "MODEL_NM", "PRD_OPT_IDX", "ORD_MST_VDR_BNF_ID",  "KSTBIT",     "ORD_MST_REG_DT",  "RDP_MST_NO", "SELLER_NAME", "ORD_MST_REC_TXT", "UTM_SOURCE",  "UTM_MEDIUM",  "UTM_CAMPAIGN",  "UTM_TERM",  "UTM_CONTENT"};
            String [] cellType =    {"Number",  "String",      "String",        "String", "String",   "String",      "String",        "String",         "String",   "String",      "String",              "String",  "String" ,         "String",   "String" ,         "String",   "String",      "String",      "String",        "String",    "String"};
            String [] colSize =     {"50",      "50",          "50",            "50",     "50",       "50",          "150",            "80",            "80",       "80",          "50",                  "20",      "50",              "50",        "100",         "100",    "100",         "100",         "100",           "100",       "100"};
    ...
    public EXCEL orderJoinExcelDownload(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
        ...
        if (list != null) {
            ...
            excel.put("list", list);
            String [] headerTitle = {"NO",     "회원번호",   "주문번호",       "온라인상품명",   "고객명",    "연락처",   "기간계 상품코드",  "모델분류",      "지원혜택",         "모델명",      "옵션",          "추가정보",               "회원상태",     "접수일",   "가입일",     "레디플래너 번호", "영업사원", "추천인",    "UTM_SOURCE",  "UTM_MEDIUM", "UTM_CAMPAIGN",  "UTM_TERM",  "UTM_CONTENT",  "잔여회차",      "납입회차"};
            String [] cellField =   {"RNUM",   "ACCNT_NO", "ORD_MST_IDX",  "PRD_MST_NM", "MEM_NM",  "CELL",    "PROD_CD",     "MODEL_CL_NM", "PRD_MST_SPL_NM", "MODEL_NM",  "PRD_OPT_IDX",  "ORD_MST_VDR_BNF_ID",  "KSTBIT",     "REG_DM",  "JOIN_DT",  "RDP_MST_NO",   "SELLER_NAME", "ORD_MST_REC_TXT", "UTM_SOURCE",   "UTM_MEDIUM", "UTM_CAMPAIGN", "UTM_TERM",  "UTM_CONTENT",   "REST_NO",    "PAY_NO"};
            String [] cellType =    {"Number", "String",   "String",       "String",     "String",  "String",  "String",      "String",      "String",         "String",    "String",       "String",              "String",     "String",  "String",   "String",       "String",   "String",       "String",      "String",     "String",       "String",    "String",        "String",     "String"};
            String [] colSize =     {"50",     "150",      "150",          "150",        "150",     "150",     "150",         "150",         "150",            "150",       "150",          "150",                 "150",        "150",     "150",      "50",            "150",          "150",   "150",          "150",        "150",          "150",       "150",           "150",        "150"};
            excel.put("headerTitle", headerTitle);
            excel.put("cellField", cellField);
            excel.put("cellType", cellType);
            excel.put("colSize", colSize);
