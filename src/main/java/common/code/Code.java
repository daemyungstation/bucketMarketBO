...
public class Code {
    ...
    static public final int AREA_CODE = 1793; // 지역코드
    ...
    static public final int INICIS_BACK_CODE = 3220; // INICIS 은행 코드
    ...
    static public final int DSPLAY_BANNER_AREA_CODE = 3001; // 전시 배너 영역
    static public final int DISPLAY_BANNER_AREA_CATEGORY_CODE = 3206; // 전시배너영역 > 대 카테고리 영역
    static public final int DISPLAY_SKYSCRAPER = 3340; // PC 전용 > 스카이스크랩퍼
        /**************************************************************************
     * 05. 고객센터 관련 코드 그룹
     **************************************************************************/
    static public final int NOTICE_TYPE_CODE = 140; // 공지사항구분 코드
    ...
    static public final int TERM_USER_AGREEMENT_CODE = 2942; // 약관 > 이용 약관
    static public final int TERM_PERSONAL_INFORMATION_CODE = 2943; // 약관 > 개인정보
    static public final int TERM_PERSONAL_INFORMATION_CODE_GBN = 2973; // 약관 > 개인정보동의
    ...
    static public final List<Integer> TERM_CONTRACT_CONFIRM_FIRST_LIST = new ArrayList<Integer> () {
        private static final long serialVersionUID = 3848438888393672311L;
        {
            add(TERM_CONTRACT_CONFIRM_FIRST_A);
            add(TERM_CONTRACT_CONFIRM_FIRST_B);
            add(TERM_CONTRACT_CONFIRM_FIRST_C);
            add(TERM_CONTRACT_CONFIRM_FIRST_D);
            add(TERM_CONTRACT_CONFIRM_FIRST_E);
        }
    };
    static public final int TERM_CONTRACT_VENDOR_CODE = 2947; // 약관 > 제휴사 약관
     ...
     **************************************************************************/
    static public final int CLAIM_STATUS_CODE = 3020;
    ...
    static public final int PLANNER_PAY_CLASS_PRIVATE = 3369; // 개인사업자
    static public final int PLANNER_PAY_CLASS_LEGAL_PERSON = 3370; // 법인사업자

    /**************************************************************************
     * 09. 프로모션 관련 코드 그룹
     **************************************************************************/
    static public final int PROMOTION_PRODUCT_COL = 3159; // 상품 진열 개수 코드
    
    /**************************************************************************
     * 10. 템플릿 관련 코드 그룹
     **************************************************************************/
    static public final int TEMPLATE_CODE = 3186; // 템플릿 코드
    static public final int LIFE_SERVICE = 3187; // 라이프서비스 템플릿 코드
    static public final int PRODUCT_TYPE = 3188; // 상품유형 템플릿 코드
     ...
     * 12. DLCC 회원 상태 코드 그룹
     **************************************************************************/
    static public final int MEMBER_JOIN = 3214; // 회원 상태 그룹 코드
    static public final int MEMBER_JOIN_READY = 3215; // 회원 상태 > 대기
    static public final int MEMBER_JOIN_COMPLETE = 3216; // 회원 상태 > 가입
    static public final int MEMBER_JOIN_CANCEL = 3217; // 회원 상태 > 해약
    static public final int MEMBER_JOIN_EVENT = 3218; // 회원 상태 > 행사
    ...
    static public final int DLCC_PRODUCT_TYPE_MONTHLY_SUPPORT = 3352; // DLCC 할부지원 상품 코드 그룹
    ...
    static public final int RENTAL_NOTPLACE = 3357; //렌탈부재
    ...
    /**************************************************************************
     * 13. DLCC 할부지원형 상품코드 그룹
     **************************************************************************/
    static public final int INSTALLMENT_SUPPORT = 3352; // 할부지원형 상품코드 그룹    
}
