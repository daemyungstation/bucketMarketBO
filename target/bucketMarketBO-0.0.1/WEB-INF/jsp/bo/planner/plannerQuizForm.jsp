                    ...
                    <form id="frm" name="frm" enctype="multipart/form-data">
                        <table cellspacing="0" class="table-row table-a">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="RDP_EDU_NM" name="RDP_EDU_NM" class="text xlarge" maxlength="200" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="radio" id="RDP_EDU_YN0" name="RDP_EDU_YN" value="Y" class="radio" checked="checked" />
                                        <label for="RDP_EDU_YN0">노출</label>
                                        <input type="radio" id="RDP_EDU_YN1" name="RDP_EDU_YN" value="N" class="radio" />
                        ...
                        <table cellspacing="0" class="table-row table-a">
                            ...
                            <tbody>
                                <tr>
                                    <th>
                                        <label class="label">
                                            <span>업로드<i class="require"><em>필수입력</em></i></span>
                                        </label>
                                    </th>
                                    <td>
                                        <table cellspacing="0" class="table-row table-a">
                        ...
                        <div id="quizList">
                            <table cellspacing="0" class="table-row table-a quiz">
                                <!-- table -->
                                <input type="hidden" name="RDP_QUIZ_NO" value="0" />
                                <input type="hidden" name="QUIZ[0].RDP_QUIZ_IDX" value="" />
                                <input type="hidden" name="QUIZ[0].RDP_QUIZ_DEL_YN" value="N" />
                                <colgroup>
                                    <col style="width: 15%;" />
                                    <col style="width: auto;" />
                                </colgroup>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="QUIZ[0].RDP_QUIZ_SORT" class="text number quizNo" value="1" readonly="readonly"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="QUIZ[0].RDP_QUIZ_NM" class="text xlarge" maxlength="200" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td>
                                            <table cellspacing="0" class="table-row table-a">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%-- 문항 목록 --%>
                                                    <tr class="answer">
                                                        <input type="hidden" name="QUIZ[0].RDP_ITEM_IDX" value="" />
                                                        <input type="hidden" name="QUIZ[0].RDP_ITEM_DEL_YN" value="N" />
                                                        <td>
                                                            <span>1</span>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="QUIZ[0].RDP_ITEM_NM" class="text xlarge" maxlength="200"/>
                                                        </td>
                                                        <td>
                                                            <input type="radio" id="QUIZ[0].RDP_ITEM_YN[0]_Y" name="QUIZ[0].RDP_ITEM_YN[0]" value="Y" class="radio answerYn" />
                                                            <label for="QUIZ[0].RDP_ITEM_YN[0]_Y">예</label>
                                                            <input type="radio" id="QUIZ[0].RDP_ITEM_YN[0]_N" name="QUIZ[0].RDP_ITEM_YN[0]" value="N" class="radio answerYn" checked="checked" />
                                                            <label for="QUIZ[0].RDP_ITEM_YN[0]_N">아니오</label>
                                                        </td>
                                                        <td>
