            ...
            <div id="contents">
                ...
                <div class="container">
                    ...
                    <form id="frm" name="frm">
                        <input type="hidden" name="CMN_COM_IDX" value="<c:out value="${commandMap.CMN_COM_IDX }"/>"/>
                        <input type="hidden" name="PRD_TPL_TYPE" value="<c:out value="${commandMap.CMN_COM_IDX }"/>"/>
                        <table cellspacing="0" class="table-row table-a">
                            ...
                            <tbody>
                                            ...
                                            <c:if test="${not empty gbunCodeList}">
                                                <c:forEach var="row" items="${gbunCodeList }" varStatus="i">
                                                    <label for="PRD_TPL_SVC<c:out value="${i.index}"/>">
                                                        <input type="radio" name="PRD_TPL_SVC" id="PRD_TPL_SVC<c:out value="${i.index}"/>" class="radio" value="<c:out value="${row.CMN_COM_IDX }"/>" <c:if test="${i.index eq 0 }">checked="checked"</c:if>/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label for="PRD_TPL_BND_YN0">
                                            <input type="radio" name="PRD_TPL_BND_YN" id="PRD_TPL_BND_YN0" class="radio" value="Y" checked="checked"/>
                                            <span>채권</span>
                                        </label>
                                        <label for="PRD_TPL_BND_YN1">
                                            <input type="radio" name="PRD_TPL_BND_YN" id="PRD_TPL_BND_YN1" class="radio" value="N"/>
                                            <span>비채권</span>
                                        </label>
                                    </td>
                                </tr>                                
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="PRD_TPL_NM" id="PRD_TPL_NM" class="text xlarge" value="" maxlength="70"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <label for="PRD_TPL_YN0">
                                            <input type="radio" name="PRD_TPL_YN" id="PRD_TPL_YN0" class="radio" value="Y" checked="checked"/>
                                            <span>사용</span>
                                        </label>
                                        <label for="PRD_TPL_YN1">
                                            <input type="radio" name="PRD_TPL_YN" id="PRD_TPL_YN1" class="radio" value="N"/>
                                            <span>사용안함</span>
                                        </label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <textarea name="PRD_TPL_PC_DTL_DSC" id="PRD_TPL_PC_DTL_DSC" class="textarea xlarge" style="height: 500px; width: 100%"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <textarea name="PRD_TPL_MB_DTL_DSC" id="PRD_TPL_MB_DTL_DSC" class="textarea xlarge" style="height: 500px; width: 100%"></textarea>
                                    </td>
                                </tr>                                
                            </tbody>
                        </table>
