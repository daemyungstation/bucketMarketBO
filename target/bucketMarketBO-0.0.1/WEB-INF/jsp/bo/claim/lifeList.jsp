                                        ...
                                        <c:when test="${not empty list }">
                                            <c:forEach var="row" items="${list }" varStatus="i">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <c:out value="${row.CLM_LFS_SVC_NM }" />
                                                    </td>
                                                    <td>
                                                        <ui:formatDate value="${row.CLM_LFS_REG_DT }" pattern="yyyy.MM.dd" />
                                                    </td>
                                                    <td>
                                                        <select name="CMN_COM_IDX" class="select half" data-clm_lfs_idx="<c:out value="${row.CLM_LFS_IDX }"/>">
                                                            <c:if test="${not empty codeList }">
            ...
            $wrapper.on("click", ".save", function() {
                if (confirm("저장 하시겠습니까?")) {
                    ...
                    $target.each(function () {
                        var $this = $(this);
                        param.CLM_LFS_IDX = $this.data("clm_lfs_idx");
