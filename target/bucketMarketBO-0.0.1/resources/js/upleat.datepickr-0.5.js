...
(function($, window, document, ua) {
    ...
    $.datePickr = function(options) {
        ...
        var buildCalendar = function(date, _input) {
            ...
            _html += '</div>';
            _html += '<div class="today"><a href="javascript:;" style="color:#ff0080" class="today" data-day=' + textDate(dateToday.getDate(), dateToday.getMonth() + 1, dateToday.getFullYear(), false) + '>오늘날짜: <span>' + textDate(dateToday.getDate(), dateToday.getMonth() + 1, dateToday.getFullYear(), true) + '</span><span class="sr-only"> - 해당 년/월로 이동</span></a></div>';
            _html += '</div>';
        ...
        var _click = function(e) {
            ...
            var alignClass = 'datepicker-left';
            if ($this.hasClass('align-right')) {
                alignClass = '';
            }
            base.$calendar = $('<div class="section-datepicker lg ' + alignClass + '"></div>');
