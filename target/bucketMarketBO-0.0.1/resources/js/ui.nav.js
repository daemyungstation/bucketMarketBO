    ...
    var _returnJsonTree = function(_json) {
        ...
        var _core = function(_arr) {
            ...
            $.each(_arr, function(i) {
                var _this = this;
                _result += '<li>';
                _result += '<a href="' + _this.src + '" + onclick="' + _this.onclick + '" data-menu_group="' + _this.menu_group + '" data-menu_subclass="' + _this.menu_subclass + '"><span class="' + _this.icon_class + '">' + _this.name + '</span></a>';
